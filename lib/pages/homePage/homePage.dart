    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Container(
            height:
                MediaQuery.of(context).padding.top + 130, // Increased height
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                            ...
                            } else if (feature['title'] == 'Jam Pulang') {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                            ...
                            } else if (feature['title'] == 'Riwayat Absensi') {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) =>
